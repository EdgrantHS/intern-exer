...
export default function SelamatDatang() {
  return (
    <div className="bg-white w-screen px-12">
      ...
      <section
        id="team-boxes"
        className="flex gap-8 py-8 overflow-x-auto scrollbar-hide hover:scale-[101%] transition-all duration-300 ease-in-out overflow-y-visible
