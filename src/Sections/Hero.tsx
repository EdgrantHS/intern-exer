  ...
  return(
    <div id="landing-container" className="
      ...
      <div id="landing-image" className="
              ...
              relative
            ">
        <img src={HeroImg} alt="GioStare" className="
      ...
      <div id="landing-text-container" className="
        ...
        <h1 id="landing-title" className="
                ...
                md:text-start
                  text-center
            ">Welcome to Internship Exercise <p className='text-primary font-bold'>Front End</p></h1>

        <p id="landing-subtitle" className="
                mt-4 text-secondary
                md:text-start
                  text-center
              ">Website ini dibuat oleh Edgrant sebagai sarana pembelajaran Front End. Terdapat sumber belajar dan juga website ini sendiri dapat jadi sumber belajar. Kode websiite disediakan pada button berikut. </p>
